...
const actionType = {
  ...
  ERROR: 'ERROR',
  GET_PIPELINE_README:"GET_PIPELINE_README",
  GET_ALGORITHM_README:"GET_ALGORITHM_README",
...
restHelper(actionType.GET_PIPELINE_README);
restHelper(actionType.GET_ALGORITHM_README);
restHelper(actionType.POST_PIPELINE_README);
restHelper(actionType.POST_ALGORITHM_README);
