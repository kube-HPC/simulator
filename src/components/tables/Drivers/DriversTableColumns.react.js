...
const driversTableColumns = () => [
  ...
  },
  {
    ...
    key: 'driverStatus',
    render: driverStatus => (
      <Tag color={COLOR_PIPELINE_STATUS[driverStatus]}>{driverStatus}</Tag>
    ),
  ...
  },
  {
    ...
    key: 'jobStatus',
    render: jobStatus => (
      <Tag color={COLOR_PIPELINE_STATUS[jobStatus]}>{jobStatus}</Tag>
    ),
  ...
  },
  {
    ...
    key: 'paused',
    render: paused => (
      <Tag color={paused ? 'red' : 'green'}>{paused ? 'paused' : 'ready'}</Tag>
    ),
