...
const ItemMargin = styled(Item)`
  margin-top: ${({ margin }) => `${margin ? margin : 10}px`};
`;

const cycle = r => `translate3d(0, ${15 * Math.sin(r + (2 * Math.PI) / 1.6)}px, 0)`;
  ...
  return (
    <Container>
      ...
      <ItemMargin>
        ...
        >
          <ellipse cx="394.5" cy="64.502" rx="394.5" ry="64.5" fill="black" fillOpacity="0.19" />
        </animated.svg>
      </ItemMargin>
