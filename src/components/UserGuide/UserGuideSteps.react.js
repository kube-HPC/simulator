...
const steps = [
  {
    ...
    content: (
      <>
        <Paragraph>
          <Text strong>HKube</Text> is a cloud-native open source framework which run distributed
          pipeline of algorithms.
        </Paragraph>
        <Paragraph>
          The <Text strong>Dashboard</Text> supports every functionality <Text strong>HKube</Text>{' '}
          has to offer.
        </Paragraph>
      </>
    ),
  ...
  },
  {
    ...
    content: (
      <Paragraph>
        Visit <Text strong>HKube's</Text> <Text code>Website</Text> and <Text code>Github</Text>{' '}
        repository.
        <br />
  ...
  },
  {
    ...
    content: (
      <Paragraph>
        ...
        <br />
        Each table has its unique actions, like re-running <Text code>Jobs</Text>, starting a{' '}
        <Text code>Pipeline</Text> and updating <Text code>Algorithm</Text> resources. <br />
        <Divider />
        Notice the <Tag style={{ color: COLOR_LAYOUT.colorPrimary }}>The Entries Count</Tag>
        for each table.
        <br />
...

  {
    ...
    content: (
      <>
        ...
        <Paragraph>
          <Text underline>For example</Text>, we can see the jobs <Text code>Status</Text>,{' '}
          <Text code>Live Progress</Text>, job <Text code>Re-Run</Text> and{' '}
          <Text code>Download</Text> its results.
          <Divider />
  ...
  },
  {
    ...
    content: (
      <Paragraph>
        The <Text code>Operations</Text> allows you to add data to <Text strong>HKube</Text>.
        <Divider />
        <Text underline>For example</Text>, you can add a <Text code>Pipeline</Text> an{' '}
        <Text code>Algorithm</Text> and even <Text code>Debug</Text> your{' '}
  ...
  },
  {
    ...
    content: (
      <Paragraph>
        ...
        <br />
        Inspect additional data like <Text code>Graph</Text>, <Text code>Trace</Text>,{' '}
        <Text code>JSON</Text> 🤘.
      </Paragraph>
    ),
    placement: 'top',
