...
@font-face {
  font-family: 'anticon';
  src: '../assets/iconfonts/iconfont.eot';
  /* IE9*/
  src:'../assets/iconfonts/iconfont.eot' format('embedded-opentype'), /* chrome、firefox */  '../assets/iconfonts/iconfont.woff' format('woff'), /* chrome、firefox、opera、Safari, Android, iOS 4.2+*/  '../assets/iconfonts/iconfont.ttf' format('truetype'), /* iOS 4.1- */ 
   '../assets/iconfonts/iconfont.svg#iconfont' format('svg');
}
.anticon {
  display: inline-block;
  font-style: normal;
